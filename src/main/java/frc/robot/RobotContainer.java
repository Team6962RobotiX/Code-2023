...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new JoystickButton(utilityJoystick, 11).onTrue(arm.toPosition(1.15, 0.465)); // FLOOR
    ...
    new JoystickButton(utilityJoystick, 5).onTrue(arm.toPosition(0.9, 0.465)); // FLOOR
